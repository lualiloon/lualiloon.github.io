...
var G__21317 = devtools.prefs.pref.call(null,v);
v = G__21317;
continue;
} else {
return v;
...
}catch (e21318){var _e__20721__auto__ = e21318;
return false;
}})();
...
}catch (e21320){var _e__20721__auto__ = e21320;
return false;
}})();
...
}catch (e21322){var _e__20721__auto__ = e21322;
return false;
}}
}
});
...
var vec__21324 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__21324,(0),null);
var name = cljs.core.nth.call(null,vec__21324,(1),null);
...
return cljs.core.some.call(null,(function (p1__21327_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__21327_SHARP_);
}),template);
});
