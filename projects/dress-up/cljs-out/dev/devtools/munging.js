...
var o21201 = temp__5802__auto__;
var temp__5802__auto____$1 = (o21201["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o21202 = temp__5802__auto____$1;
return (o21202["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__20714__auto__ = f;
return (o__20714__auto__["toString"]).call(o__20714__auto__);
} else {
return "";
}
}catch (e21203){var _ = e21203;
return "";
}});
...
try{var o__20714__auto___21205 = t;
(o__20714__auto___21205["cljs$lang$ctorPrWriter"]).call(o__20714__auto___21205,t,writer);
}catch (e21204){var __21206 = e21204;
}
...
var char_code = (function (){var o__20714__auto__ = (new String(char$));
return (o__20714__auto__["charCodeAt"]).call(o__20714__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__20714__auto__ = String;
return (o__20714__auto__["fromCharCode"]).call(o__20714__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__21207 = num_code;
switch (G__21207) {
case (1):
return (185);
...
var o__20714__auto__ = String;
return (o__20714__auto__["fromCharCode"]).call(o__20714__auto__,superscript_code);
});
/**
...
}catch (e21209){var _e__20721__auto__ = e21209;
return false;
}})())){
...
var vec__21210 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__21210,(0),null);
...
var len__5769__auto___21219 = arguments.length;
var i__5770__auto___21220 = (0);
while(true){
if((i__5770__auto___21220 < len__5769__auto___21219)){
args__5775__auto__.push((arguments[i__5770__auto___21220]));

var G__21221 = (i__5770__auto___21220 + (1));
i__5770__auto___21220 = G__21221;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__21215){
var vec__21216 = p__21215;
var ns_detector = cljs.core.nth.call(null,vec__21216,(0),null);
...
var G__21222 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__21223 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__21222;
remaining_tokens = G__21223;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq21213){
var G__21214 = cljs.core.first.call(null,seq21213);
var seq21213__$1 = cljs.core.next.call(null,seq21213);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21214,seq21213__$1);
}));
...
var vec__21227 = cljs.core.split_with.call(null,(function (p1__21226_SHARP_){
return cljs.core.not_EQ_.call(null,p1__21226_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__21227,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__21227,(1),null);
...
var vec__21233 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__21233,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__21233,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__21236 = cljs.core.rest.call(null,remaining_tokens);
var G__21237 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__21236;
name_tokens = G__21237;
continue;
} else {
...
var vec__21240 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__21240,(0),null);
var arity = cljs.core.nth.call(null,vec__21240,(1),null);
var vec__21243 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__21243,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__21243,(1),null);
var vec__21246 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__21246,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__21246,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__21246,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__21246,(3),null);
...
var vec__21252 = result;
var munged_ns = cljs.core.nth.call(null,vec__21252,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__21252,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__21252,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__21252,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__21252,(4),null);
var arity = cljs.core.nth.call(null,vec__21252,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__21256 = temp__5802__auto__;
var munged_name = cljs.core.nth.call(null,vec__21256,(0),null);
var args = cljs.core.nth.call(null,vec__21256,(1),null);
var vec__21259 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__21259,(0),null);
var name = cljs.core.nth.call(null,vec__21259,(1),null);
...
var G__21262 = (arity + (1));
var G__21263 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__21264){
var vec__21265 = p__21264;
var arity = cljs.core.nth.call(null,vec__21265,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__21265,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__21268_SHARP_){
return cljs.core.get.call(null,arities,p1__21268_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__21269_SHARP_){
return cljs.core.drop.call(null,(2),p1__21269_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__21272){
var vec__21273 = p__21272;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__21273,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq21270){
...
var map__21281 = options;
var map__21281__$1 = cljs.core.__destructure_map.call(null,map__21281);
var include_ns_QMARK_ = cljs.core.get.call(null,map__21281__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__21281__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__21281__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__21281__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__21282 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__21282,(0),null);
var fn_name = cljs.core.nth.call(null,vec__21282,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__21282,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__21282,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__21282,(4),null);
var arity = cljs.core.nth.call(null,vec__21282,(5),null);
...
var o__20714__auto__ = f;
return (o__20714__auto__["getBasis"]).call(o__20714__auto__);
});
/**
...
}catch (e21285){var _e__20721__auto__ = e21285;
...
var G__21286 = (obj[cljs.core.first.call(null,path)]);
var G__21287 = cljs.core.rest.call(null,path);
obj = G__21286;
path = G__21287;
continue;
} else {
...
var _STAR_ = (function (accum,p__21288){
var vec__21289 = p__21288;
var bit = cljs.core.nth.call(null,vec__21289,(0),null);
var protocol = cljs.core.nth.call(null,vec__21289,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__21292){
var vec__21293 = p__21292;
var ns = cljs.core.nth.call(null,vec__21293,(0),null);
var name = cljs.core.nth.call(null,vec__21293,(1),null);
var selector = cljs.core.nth.call(null,vec__21293,(2),null);
...
var post_process = (function (p__21297){
var vec__21298 = p__21297;
var munged_name = cljs.core.nth.call(null,vec__21298,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__21298,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__21296_SHARP_){
return (obj[cljs.core.first.call(null,p1__21296_SHARP_)]);
}),sorted_matches);
