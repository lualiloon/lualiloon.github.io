...
var G__10727 = o;
reagent.impl.template.goog$module$goog$object.set.call(null,G__10727,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__10729__i < G__10729__a.length) {G__10729__a[G__10729__i] = arguments[G__10729__i + 0]; ++G__10729__i;}
  args = new cljs.core.IndexedSeq(G__10729__a,0,null);
} 
...
var G__10731 = o;
reagent.impl.template.goog$module$goog$object.set.call(null,G__10731,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__10733__i < G__10733__a.length) {G__10733__a[G__10733__i] = arguments[G__10733__i + 0]; ++G__10733__i;}
  args = new cljs.core.IndexedSeq(G__10733__a,0,null);
} 
...
var G__10735 = props;
var G__10735__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__10735,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__10735);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__10735__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__10736 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__10736,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__10736;
}
})(),id_class);
...
var G__10737 = (cljs.core.count.call(null,argv) - first_child);
switch (G__10737) {
case (0):
...
var vec__10739 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__10739,(0),null);
var id = cljs.core.nth.call(null,vec__10739,(1),null);
var className = cljs.core.nth.call(null,vec__10739,(2),null);
...
var temp__5808__auto___10742 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5808__auto___10742 == null)){
} else {
var key_10743 = temp__5808__auto___10742;
(jsprops.key = key_10743);
}
...
var temp__5808__auto___10744 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5808__auto___10744 == null)){
} else {
var key_10745 = temp__5808__auto___10744;
(jsprops.key = key_10745);
}
...
var temp__5808__auto___10746 = reagent.impl.util.react_key_from_vec.call(null,argv);
if((temp__5808__auto___10746 == null)){
} else {
var key_10747 = temp__5808__auto___10746;
(jsprops.key = key_10747);
}
...
var temp__5808__auto___10748 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5808__auto___10748 == null)){
} else {
var key_10749 = temp__5808__auto___10748;
(jsprops.key = key_10749);
}
...
var temp__5808__auto___10750 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5808__auto___10750 == null)){
} else {
var key_10751 = temp__5808__auto___10750;
(jsprops.key = key_10751);
}
...
return cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__10752_SHARP_){
return reagent.impl.protocols.as_element.call(null,compiler,p1__10752_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__10753 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx,compiler);
}));
var res = cljs.core.nth.call(null,vec__10753,(0),null);
var derefed = cljs.core.nth.call(null,vec__10753,(1),null);
...
break;
default:
var G__10758 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
var G__10759 = compiler;
v = G__10758;
compiler = G__10759;
continue;
...
var G__10760 = tag;
var G__10760__$1 = (((G__10760 instanceof cljs.core.Keyword))?G__10760.fqn:null);
switch (G__10760__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template10763 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template10763 = (function (opts,id,fn_to_element,parse_fn,meta10764){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template10763.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_10765,meta10764__$1){
var self__ = this;
var _10765__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template10763(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta10764__$1));
}));

(reagent.impl.template.t_reagent$impl$template10763.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_10765){
var self__ = this;
var _10765__$1 = this;
return self__.meta10764;
}));

(reagent.impl.template.t_reagent$impl$template10763.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template10763.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template10763.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
return self__.parse_fn.call(null,this$__$1,tag_name,tag_value);
}));

(reagent.impl.template.t_reagent$impl$template10763.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element.call(null,this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template10763.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element.call(null,this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template10763.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta10764","meta10764",2100288143,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template10763.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template10763.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template10763");

(reagent.impl.template.t_reagent$impl$template10763.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write.call(null,writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template10763");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template10763.
 */
reagent.impl.template.__GT_t_reagent$impl$template10763 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template10763(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta10764){
return (new reagent.impl.template.t_reagent$impl$template10763(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta10764));
});

}

return (new reagent.impl.template.t_reagent$impl$template10763(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
